...
<body>
    ...
    <ul class="nav">
        ...
        <li class="nav-item"><a class="nav-link"  href="ifStatements.php">IF ELSE</a></li>
        <li class="nav-item"><a  class="nav-link" href="switchStatements.php">Switch Statements</a></li>
        <li class="nav-item"><a class="nav-link"  href="forLoop.php">For Loop</a></li>
        <li class="nav-item"><a  class="nav-link" href="whileLoop.php">While Loop</a></li>
        ...
        <li class="nav-item"><a class="nav-link"  href="dateAndTime.php">Date and Time Manipulation</a></li>
